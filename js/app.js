...
const ALTURA_VH_DESKTOP = {
  ...
  // 21 de las 37 fotos no traían canal alpha (fondo blanco liso) y se
  // reprocesaron dos veces: la primera pasada (flood-fill simple) dejaba un
  // halo blanco visible al escalar la imagen en el navegador (el usuario lo
  // detectó a ojo) — el fix real fue "sangrar" el color del contenido unos
  // px hacia afuera antes de poner alpha 0, así el navegador interpola
  // color-contra-color en el borde en vez de color-contra-blanco-de-fondo.
  "img/buzos/buzo-sunforce-rayas-verde.png": 25.4096,
  "img/buzos/buzo-bolivia-azul.png": 25.3413,
  "img/buzos/buzo-nike-verde-textura.png": 16.0605,
  "img/buzos/buzo-vans-azul.png": 15.3946,
  "img/buzos/camisa-urbano-gris.png": 27.1709,
  ...
  "img/buzos/buzo-punto-verde-liso.png": 25.5473,
  "img/buzos/buzo-punto-grafico-azul.png": 15.6587,
  "img/buzos/buzo-vans-beige.png": 17.1413,
  "img/buzos/buzo-cuartozip-rojo.png": 16.1792,
  "img/buzos/buzo-cuartozip-gris.png": 15.7079,
  "img/buzos/buzo-gris-liso.png": 17.1145,
  "img/buzos/camisa-zip-foundedbysole-marron.png": 27.0452,
  "img/buzos/camisa-flanela-mostaza.png": 27.1205,
  "img/buzos/camisa-flanela-ripcurl-beige.png": 26.6621,
  "img/buzos/buzo-santacruz-tiedye-azul.png": 24.6202,
  "img/buzos/buzo-punto-ripcurl-gris.png": 27.0452,
  "img/buzos/buzo-lacoste-azul.png": 27.1709,
  "img/buzos/buzo-punto-ripcurl-verde.png": 27.0953,
  "img/buzos/buzo-punto-quince-azul.png": 27.4261,
  "img/buzos/buzo-punto-lacoste-bordo.png": 27.4261,
  "img/buzos/buzo-quince-gris-rojo.png": 24.7661,
...
const ALTURA_VH_MOBILE = {
  ...
  "img/buzos/buzo-sunforce-rayas-verde.png": 30.2273,
  "img/buzos/buzo-bolivia-azul.png": 30.146,
  "img/buzos/buzo-nike-verde-textura.png": 19.1056,
  "img/buzos/buzo-vans-azul.png": 18.3135,
  "img/buzos/camisa-urbano-gris.png": 32.3226,
  "img/buzos/buzo-punto-verde-liso.png": 30.3911,
  "img/buzos/buzo-punto-grafico-azul.png": 18.6277,
  "img/buzos/buzo-vans-beige.png": 20.3913,
  "img/buzos/buzo-cuartozip-rojo.png": 19.2467,
  "img/buzos/buzo-cuartozip-gris.png": 18.6862,
  "img/buzos/buzo-gris-liso.png": 20.3594,
  "img/buzos/camisa-zip-foundedbysole-marron.png": 32.173,
  "img/buzos/camisa-flanela-mostaza.png": 32.2626,
  "img/buzos/camisa-flanela-ripcurl-beige.png": 31.4836,
  "img/buzos/buzo-santacruz-tiedye-azul.png": 29.0725,
  "img/buzos/buzo-punto-ripcurl-gris.png": 32.173,
  "img/buzos/buzo-lacoste-azul.png": 32.3226,
  "img/buzos/buzo-punto-ripcurl-verde.png": 32.2326,
  "img/buzos/buzo-punto-quince-azul.png": 32.6261,
  "img/buzos/buzo-punto-lacoste-bordo.png": 32.6261,
  "img/buzos/buzo-quince-gris-rojo.png": 29.2448,
